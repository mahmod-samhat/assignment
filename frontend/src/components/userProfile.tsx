...
export default function UserEdit() {
  ...
  const formik = useFormik({
    ...
    async onSubmit(values) {
      userService.updateUser({ ...client, ...values }).then(() => {
  ...
  return (
    <>
      ...
      >
        <Typography align="left" px={10} pt={3} fontSize="30px">
          Edit User
          <AutoFixHighIcon />
        </Typography>
        <Grid
        ...
        >
          <Grid item xs={10}>
            ...
            >
              ...
              >
                <Typography sx={{ fontWeight: "bold" }}>ID : {id}</Typography>
                <Box display="flex">
                  <Tooltip title="Save">
                    <Button
                      type="submit"
                  ...
                  {permissions.canDelete() && (
                    <Tooltip title="Delete" sx={{ color: "red" }}>
                      <IconButton
                        onClick={() => {
                          userService.deleteUser(client.id).then(() => {
